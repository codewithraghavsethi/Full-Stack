...
import { assets, features } from '../assets/greencart_assets/assets.js'
...
const BottamBanner = () => {
  return (
    <div className='relative mt-24'>
       ...
       <div className='abosolute inset-0 flex flex-col items-center md:items-end md:justify-center pt-16 md:pt-0 md:pr-24'>
